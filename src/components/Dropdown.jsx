        ...
        <div className="relative">
            ...
            <ul className={`absolute top-[103%] right-0 transition-all duration-1000 bg-cyan-600 py-6 text-white font-medium ${isOpen ? 'block' : 'hidden'}`} style={{ minWidth: "10rem" }}>
                <li className="py-1 block w-full">
                    <Link className="py-1 px-5 hover:bg-cyan-400 block w-full" to="/add-password">Add Password</Link>
                </li>
                <li className="py-1 block w-full">
                    <Link className="py-1 px-5 hover:bg-cyan-400 block w-full" to="/my-password">My Password</Link>
                </li>
