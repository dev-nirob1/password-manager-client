...
const Login = () => {
    const {facebookLogin, googleLogin} = useContext(AppContext)
    ...
    return (
        <div className="max-w-xl mx-auto text-center">
            <div className="py-10">
                <div className="px-8 py-16 bg-white shadow-2xl">
                    ...
                    <div className="my-5">
                        ...
                        <button onClick={handleGoogleLogin} className="py-3 w-full font-medium text-white bg-pink-600 rounded">
                            Sign in with Google
                        </button>
                    </div>
                </div>
